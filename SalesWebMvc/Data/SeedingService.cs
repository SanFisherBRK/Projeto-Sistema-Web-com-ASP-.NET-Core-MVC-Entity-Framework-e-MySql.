...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //Metodo para popular minha base de dados
        public void Seed()
        {
            // Any() Testa se existe algum registro nesta tabela
            ...
            //Criando os dados do Department para popular o DB
            Department d1 = new Department(1, "Computer");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            //Criando os vendedores para popular o DB
            ...
            //Criando os registros de vendas para popular o DB
            ...
            //Mandar o EntitiesFramewrk salvar esses registro no banco de dados
            ...
            //Efetivando alterações, salvando e confirmando as alterações no banco de dados
